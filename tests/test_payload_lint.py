...
def test_project_source_is_exempt_from_the_ceiling(tmp_path):
    """Python test source carries no Clavia byte at any size.

    The exemption is the CLASS's, stated here and not granted by a row of its
    own: the ceiling exists to notice bulk data, and the size of source is a
    code-review concern.
    """
