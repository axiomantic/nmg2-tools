...
patches. A construct a real patch uses that the specification does not describe
passes here and fails the T1 half against the G2 Demo corpus.
...
def test_the_minimum_file_parses_to_one_empty_0x21_object_and_a_valid_crc():
    """The minimum file: a text header, the two-byte binary
...
def test_every_object_type_the_specification_names_is_read_in_order():
    """The union of the specified types, read in
...
# ---------------------------------------------------------------------------
# The CRC coverage. The routine covers the version and
