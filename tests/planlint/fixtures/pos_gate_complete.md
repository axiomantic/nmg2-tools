# A plan whose completion markers rest on completed work

This is the SILENT half of the calibrated pair. `neg_gate_incomplete.md` is this
document with two `~~` pairs added to one line and nothing else changed.
